...
public class PublicControllerOld implements Redirect, Toasts {
    private static final Logger LOGGER = LoggerFactory.getLogger(PublicControllerOld.class);
    ...
    @Autowired
    public PublicControllerOld(ClientService cs, DriverService ds, ImageService is) {
        this.cs = cs;
        this.ds = ds;
        this.is = is;
    }

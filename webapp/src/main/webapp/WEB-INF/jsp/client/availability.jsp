                ...
                <c:otherwise>
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                        ...
                        <c:forEach items="${users}" var="user">
                            <button class="nav-link text-truncate" style="max-width: 200px;" id="${user.id}-tab"
                                    data-bs-toggle="pill" data-bs-target="#${user.id}"
                                    type="button" role="tab" aria-controls="${user.id}" aria-selected="false">
                    ...
                    <div class="tab-content flex-grow-1 px-2" id="v-pills-tabContent">
                        <c:forEach items="${users}" var="user">
                            <div class="tab-pane fade show" id="${user.id}" role="tabpanel"

        ...
        <div class="col-lg-8">
            ...
            <div class="chat-box border rounded p-3 mb-3 d-flex flex-column-reverse" style="height: 60vh; overflow-y: auto;">
                <c:forEach var="message" items="${messages}">
                    <div class="d-flex <c:choose><c:when test="${message.sentByDriver}">justify-content-end</c:when><c:otherwise>justify-content-start</c:otherwise></c:choose> mb-2">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong><spring:message code="generic.word.description"/>:</strong> ${recipient.description}</p>

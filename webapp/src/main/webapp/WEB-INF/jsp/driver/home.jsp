        ...
        <div class="row row-cols-3">
            <c:forEach var="booking" items="${bookings}">
                <div class="col mb-4">
                    <div class="card mb-3">
                        <div class="card-body">
                            <h5 class="card-title"><spring:message code="driver.home.date"/>: <c:out
                                    value="${booking.date}"/></h5>
                            <p class="card-text"><spring:message code="driver.home.client"/>: <c:out
                                    value="${booking.client.username}"/></p>
                            <p class="card-text"><spring:message code="driver.home.clientMail"/>: <c:out

...
<%@ attribute name="tooltipCode" required="true" type="java.lang.String" %>
...
<spring:message code="${tooltipCode}" var="title"/>
<div data-bs-toggle="tooltip" data-bs-title="${title}" class="${cssClass}">
    <button type="button" class="btn btn-primary"
            data-bs-toggle="modal" data-bs-target="#${targetId}"
    >

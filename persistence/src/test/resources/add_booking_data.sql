...
values (1, 'JuanClient', 'juanC@mail.com', '123321', 'SPANISH', '2024-11-7 12:00:00'),
       (2, 'AnotherJuanClient', 'AjuanC@mail.com', '123321', 'SPANISH', '2024-11-7 12:00:00'),
       (3, 'JuanDriver', 'juanD@mail.com', '123321', 'SPANISH', '2024-11-7 12:00:00'),
       (4, 'PedroDriver', 'pedro@mail.com', '123321', 'SPANISH', '2024-11-7 12:00:00');


insert into client (id, zone_id)
values (1, 1),
       (2, 1);
...
values (500, '2030-5-2', 'EVENING', 2, 1, 1, 20, 'ACCEPTED'),  -- will be with booking id 500
